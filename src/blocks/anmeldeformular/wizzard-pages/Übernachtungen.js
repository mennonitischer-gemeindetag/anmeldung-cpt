...
export default () => {
	...
	return (
		<Wizzard.Page>
			...
			<p>
        Unterkünfte bitte selbständig buchen. Für Jugendliche, Studierende,
        Azubis und FSJler*innen steht eine Gruppenunterkunft in der Turnhalle
        des Gymnasium Weierhof zur Verfügung (Lageplan Nr. 7).
			</p>
			<div>
				<Field
					component={ 'input' }
          ...
          Jugend Übernachtung mit Frühstück - 15€
			...
			{ uebernachtung_and_breakfast && (
              ...
              Übernachtung in der Turnhalle des Gymnasium Weierhof mit Frühstück
              (08:00 – 9:00 Uhr) von Donnerstag (21.05.2020) bis Sonntag
              (24.05.2020)
						</label>
					</div>
					<div>
